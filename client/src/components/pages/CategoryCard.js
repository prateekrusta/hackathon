            ...
            <div className='cardss row'>
              ...
              <div className="cards-inner-2 col-sm-10">
                ...
                <ul className='list-cards'>
                  <li className="li-card"><b>Mobile Number</b> {"->"} {connect.phone}</li>
                  <li className="li-card"><b>State</b> {"->"} {connect.state}</li>
                  <li className="li-card"><b> District</b> {"->"} {connect.district}</li>
                  <li className="li-card"><b> Individual/ Group </b> {"->"} {connect.group}</li>
                  <li className="li-card"><b> Skills </b>{"->"} {connect.skill}</li>
                </ul>
              </div>
            </div>
          );
